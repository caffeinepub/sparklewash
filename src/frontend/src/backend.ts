...
import type { BookingInquiry as _BookingInquiry, BookingStatus as _BookingStatus, CarWashService as _CarWashService, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async adminGetAllBookings(): Promise<Array<BookingInquiry>> {
        if (this.processError) {
            try {
    ...
    async getAvailableServices(): Promise<Array<CarWashService>> {
        if (this.processError) {
            try {
    ...
    async getBookingInquiry(arg0: bigint): Promise<BookingInquiry> {
        if (this.processError) {
            try {
                const result = await this.actor.getBookingInquiry(arg0);
    ...
    async submitBookingInquiry(arg0: string, arg1: string, arg2: string, arg3: bigint, arg4: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitBookingInquiry(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    vehicleType: string;
    selectedService: _CarWashService;
    preferredDate: string;
    phoneNumber: string;
}): {
    id: bigint;
